            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4" style="margin-top: 70px">
                        <h1 class="mt-4">List Cart Daily</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <c:choose>
                                    <c:when test="${sessionScope.listOrdersDailyAndPagging == null || sessionScope.listOrdersDailyAndPagging.size() == 0}">
                                        <h1>List Order is Empty</h1>
                                    </c:when>
                                    <c:otherwise>
                                        <form action="earning-daily" method="POST">
                                            <table class="row" style="min-width: 60%;">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${sessionScope.listOrdersDailyAndPagging}" var="OD">
                ...
                <c:choose>
                    ...
                    <c:when test="${page < 2}">
                        <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                            <ul class="pagination">                               
                                <c:forEach begin="1" end="${totalPage}" var="i">
                                    <li class="page-item ${i == page?"active":""}"><a class="page-link" href="earning-daily?page=${i}">${i}</a></li>
                                    </c:forEach>
                                <li class="page-item"><a class="page-link" href="earning-daily?page=${page+1}">Next</a></li>
                            </ul>
                        </nav>
                    </c:when>
                    ...
                    <c:otherwise>
                        <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                            <ul class="pagination">
                                <li class="page-item"><a class="page-link" href="earning-daily?page=${page-1}">Previous</a></li>
                                    <c:forEach begin="1" end="${totalPage}" var="i">
                                    <li class="page-item ${i == page?"active":""}"><a class="page-link" href="earning-daily?page=${i}">${i}</a></li>
                                    </c:forEach>
                                <li class="page-item"><a class="page-link" href="earning-daily?page=${page+1}">Next</a></li>
