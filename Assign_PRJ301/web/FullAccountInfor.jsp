                                    ...
                                    <table class="row" style="min-width: 60%;">
                                        ...
                                        <tbody>
                                            <c:forEach items="${sessionScope.listAccounts}" var="A">
                                                <tr class="row mx-auto px-1 py-1 mt-2" style="border-bottom: 1px solid rgba(29, 27, 27, 0.151)">
                                                    <td scope="col" class="col-1 text-center">${A.getaId()}</td>
                                                    <td scope="col" class="col-1 text-center">${A.getaDisplayName()}</td>
                                                    <td scope="col" class="col-1 text-center">${A.getaUsername()}</td>
                                                    <td scope="col" class="col-2 text-center">${A.getaAddress() == "" ? 'Updating' : A.getaAddress()}</td>
                                                    <td scope="col" class="col-2 text-center">${A.getaEmail() == "" ? 'Updating' : A.getaEmail()}</td>
                                                    <td scope="col" class="col-1 text-center">${A.getaPhone() == "" ? 'Updating' : A.getaPhone()}</td>
                                                    <td scope="col" class="col-1 text-center">${A.getaRole()}</td>
                                                    <td scope="col" class="col-3 text-center"><a href="see-more?accountId=${A.aId}" class="btn btn-outline-secondary me-1"><i class="bi bi-eye pe-1"></i>See more</a>
                                                        <a href="delete-account?accountId=${A.aId}" class="btn btn-outline-danger">
